...
def emisionsconvp(archive, year): 
	...
	for value in head: 
		...
		if value == 'Dias' or value == 'DIAS' or value == 'dias':
			colDAYS = index
		if value == 'Dias_2014' or value == 'Dias_2015' or value == 'Dias_2016' or value == 'Dias_2017' or value == 'Dias_2018' or value == 'Dias_2019' or value == 'Dias_2020':
			colYear = index
		index += 1
	head = None
	...
	for i in range(1, matriz.shape[0]): 
		...
		if data.get(key) is None: 
			data[key] = {'General': {'COL': [], 'ROW': [], 'LAT': [], 'LON': [], 'FID_Grilla': [], 'AREA': [], 'DAYS': [], 'Year': [] }, 'Emisions': {'SEG': [], 'PM25':{'g/proyecto': [], 'E': [], 'g': [], 't': []}, 'PM10':{'g/proyecto': [], 'E': [], 'g': [], 't': []}}}
		...
		if data[key]['General']['COL'] == []:
			...
			data[key]['General']['Year'].append(int(float(matriz[i][colYear])))
		...
		#Calculation SEG
	 	...
	 	#g/Year
	 	data[key]['Emisions']['PM25']['g'].append(data[key]['Emisions']['PM25']['E'][0] * data[key]['General']['Year'][0])
	 	data[key]['Emisions']['PM10']['g'].append(data[key]['Emisions']['PM10']['E'][0] * data[key]['General']['Year'][0])
